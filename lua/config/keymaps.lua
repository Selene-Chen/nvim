...
-- lazygit
map("n", "<leader>gg", function() utils.float_term({ "lazygit" }, { cwd = utils.get_root(), esc_esc = false ,ctrl_hjkl = false}) end, { desc = "Lazygit (root dir)" })
map("n", "<leader>gG", function() utils.float_term({ "lazygit" }, {esc_esc = false,ctrl_hjkl = false}) end, { desc = "Lazygit (cwd)" })
